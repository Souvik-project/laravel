          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="fw-bold text-uppercase text-dark">Shopify</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link active" href="{{ route('user.layout.index') }}">Shop</a>
                </li>
                <li class="nav-item">
                  ...
                  <div class="col-lg-4 col-sm-6">				  	  
                    <div class="product text-center">					
                      <div class="mb-3 position-relative">				 
                        <div class="badge text-white bg-"></div><a class="d-block" href="{{ route('user.layout.show', $product->id) }}"><img class="img-fluid w-100" src="{{ asset('/images/'.$product->image) }}" alt="..."></a>
                      ...
                      <h6> <a class="reset-anchor" href="detail.html">{{ $product->pname }}</a></h6>
